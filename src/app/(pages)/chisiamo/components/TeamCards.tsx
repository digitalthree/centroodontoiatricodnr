                ...
                return(
                    ...
                    >
                        <div className="bg-gradient-to-t from-[#d8e8ff] to-white">
                            <Image src={member.imgUrl} width="600" height="743" alt=""/>
                        </div>
                        <div className="flex flex-col p-3">
                            <p className="text-menuText">{member.professione}</p>
                            <h2 className="text-primary">{member.nome}</h2>
                            <hr className="border border-primary w-[50px] mt-2 mb-2"/>
                            <p className="text-primary">
                                {member.bio.substring(0, 250)+'...'}
                            </p>
                            <button className="rounded-full border-2 border-primary mt-4 text-primary py-1"
                                    onClick={() => {
